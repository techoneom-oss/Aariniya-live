          ...
          <div style={styles.imageCol}>
            <div className="journey-image-box">
              <img 
                ...
                alt="Aarini Devrani in traditional Central Indian attire — AARINIYA brand story" 
        ...
        <div className="container">
          ...
          <div className="journey-journal-grid">
            <div className="journal-card journey-journal-card">
              <img src="/assets/aarini_devrani_5.jpg" alt="Traditional Central Indian ceremonial attire — AARINIYA brand roots" style={styles.journalImg} loading="lazy" />
            ...
            <div className="journal-card journey-journal-card">
              <img src="/assets/aarini_devrani_1.jpg" alt="Small batch quality control — AARINIYA raw honey" style={styles.journalImg} loading="lazy" />
              <div style={styles.journalCardOverlay}>
            ...
            <div className="journal-card journey-journal-card">
              <img src="/assets/aarini_devrani_2.jpg" alt="Daily forest ritual walk — Aarini Devrani AARINIYA" style={styles.journalImg} loading="lazy" />
              <div style={styles.journalCardOverlay}>
            ...
            <div className="journal-card journey-journal-card">
              <img src="/assets/aarini_devrani_3.jpg" alt="Aarini Devrani mindful wellness lifestyle" style={styles.journalImg} loading="lazy" />
              <div style={styles.journalCardOverlay}>
            ...
            <div className="journal-card journey-journal-card">
              <img src="/assets/aarini_devrani_4.jpg" alt="Aarini Devrani mindful wellness lifestyle" style={styles.journalImg} loading="lazy" />
              <div style={styles.journalCardOverlay}>
            ...
            <div className="journal-card journey-journal-card">
              <img src="/assets/product_gallery_new_4.jpg" alt="Respectful wild hive harvesting — AARINIYA tribal honey collection" style={styles.journalImg} loading="lazy" />
              <div style={styles.journalCardOverlay}>
